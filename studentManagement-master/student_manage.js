 $(document).ready(function() {
    ...
    function createTable(idx) {
        ...
        html += '<thead><tr><th>Firstname</th><th>Lastname</th><th>Email</th><th>Location</th><th>Phone</th><th>More Option</th></tr></thead>';
    ...
    function editWho(id) {
        ...
        if (editOn == false) {
            ...
            temp.marks.computers = phrases[5];
            temp.marks.english = phrases[6];
            temp.marks.hardware = phrases[7];
            temp.marks.science = phrases[8];
            data[id]=temp;
            localStorage.setItem('session', JSON.stringify(data));
